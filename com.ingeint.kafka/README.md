...
- New callout
    * Name: CName
    * Package: com.ingeint.kafka.callout
    * Example: com.ingeint.kafka.callout.CStringFormat

- New process
    * Name: PName
    * Package: com.ingeint.kafka.process
    * Example: com.ingeint.kafka.process.PGenerateWithholding

- New form
    * Name: FName
    * Package: com.ingeint.kafka.form
    * Example: com.ingeint.kafka.form.FMultiPayment

- New event
    * Name: EName
    * Package: com.ingeint.kafka.event
    * Example: com.ingeint.kafka.event.EAfterCompleteInvoice

- New model (extends class X)
    * Name: MName
    * Package: com.ingeint.kafka.model
    * Example: com.ingeint.kafka.model.MTableExample
...
- New callout
    * Create callout in package `com.ingeint.kafka.callout`, extends from `CustomCallout`
    * Register callout in `com.ingeint.kafka.component.CalloutFactory`. Example:
...
- New process
    * Create process in package `com.ingeint.kafka.process`, extends from `CustomProcess`
    * Register process in `com.ingeint.kafka.component.ProcessFactory`. Example:
...
- New form
    * Create form in package `com.ingeint.kafka.form`, extends from `CustomForm`
    * Register form in `com.ingeint.kafka.component.FormFactory`. Example:
...
- New event
    * Create event in package `com.ingeint.kafka.event`, extends from `CustomEvent`
    * Register event in `com.ingeint.kafka.component.EventFactory`. Example:
...
- New model (extends form class X)
    * Create model in package `com.ingeint.kafka.model`, extends class `X`. Example: `X_TL_TableExample -> MTableExample`
    * Register model in `com.ingeint.kafka.component.ModelFactory`. Example:
