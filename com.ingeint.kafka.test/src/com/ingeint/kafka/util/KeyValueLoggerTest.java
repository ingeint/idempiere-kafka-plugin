...
package com.ingeint.kafka.util;

import static com.ingeint.kafka.test.util.RandomTestUtil.*;
import static com.ingeint.kafka.test.util.ReflectionTestUtil.*;
...
class KeyValueLoggerTest {
	...
	void shouldPrintClassFromClass() {
		...
		verify(logger).log(Level.INFO, "class=\"com.ingeint.kafka.util.KeyValueLogger\"");
	}
	...
	void shouldPrintPackageFromClass() {
		...
		verify(logger).log(Level.INFO, "package=\"com.ingeint.kafka.util\"");
	}
